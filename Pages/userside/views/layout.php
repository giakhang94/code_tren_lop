...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?=$base_url?>/public/admin/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?=$base_url?>/public/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?=$base_url?>/public/admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?=$base_url?>/public/admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?=$base_url?>/public/admin/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?=$base_url?>/public/admin/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
    ...
    <!-- Bootstrap 3.3.5 -->
    <script src="<?=$base_url?>/public/admin/bootstrap/js/bootstrap.min.js"></script>
    <!-- Morris.js charts -->
    ...
    <!-- FastClick -->
    <script src="<?=$base_url?>/public/admin/plugins/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
